...
def main():
    ...
    obj_file    = data_root + "/flower_box.obj"
    # obj_file    = data_root + "/flower_box_samll_o.obj"
    # obj_file    = data_root + "/flower_box_setmtl.obj"
    ...
    # m_SimModelGen.mtlopt_inifile = m_SimModelGen.sim_data_fold+"/mtlopt_0.ini"
    # m_SimModelGen.startMtlOPt()

    # m_SimModelGen.mtlopt_inifile = m_SimModelGen.sim_data_fold+"/mtlopt_1.ini"
    # m_SimModelGen.startMtlOPt()

    # m_SimModelGen.mtlopt_inifile = m_SimModelGen.sim_data_fold+"/mtlopt_2.ini"
    m_SimModelGen.startMtlOPt()

    # m_SimModelGen.mtlopt_inifile = m_SimModelGen.sim_data_fold+"/mtlopt_3.ini"
    # m_SimModelGen.startMtlOPt()

    # m_SimModelGen.mtlopt_inifile = m_SimModelGen.sim_data_fold+"/mtlopt_4.ini"
    # m_SimModelGen.startMtlOPt()

    # m_SimModelGen.mtlopt_inifile = m_SimModelGen.sim_data_fold+"/mtlopt_5.ini"
    # m_SimModelGen.startMtlOPt()
