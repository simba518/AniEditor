...
template <class real>
int ReadMatrixFromDiskListOfFiles(char * fileList, int * m, int * n, real ** matrix)
{
  FILE * jobFileList = fopen(fileList,"ra");
...
void Abort_(char * reason)
{
  Abort_(reason,1);
}

void Abort_(char * reason, int exitCode)
{
  printf("%s\n",reason);
  exit(exitCode);
}
...
void ChangeMatrixHeader(char * filename, int numRows, int numColumns)
{
...
template <class real>
int ReadMatrixFromDiskTextFile(char* filename, int * m, int * n, real ** matrix)
{
  // open input
  FILE * file;
...
template <class real>
int WriteMatrixToDiskTextFile(char* filename, int m, int n, real * matrix)
{
  // open file
  FILE * fout;
...
template <class real>
int ReadModesFromDisk(char * filename, int * N, int * R, real ** frequencies, real ** modes)
{
  FILE * file;
...
int ReadModeInfoFromDisk(char * filename, int * N, int * R)
{
  FILE * file;
  file = fopen(filename,"r");
...
template <class real>
int WriteModesToDisk(char * filename, int n, int r, real * frequencies, real * modes)
{
  FILE * file;
...
template int ReadModesFromDisk<double>(char * filename, int * n, int * r, double ** frequencies, double ** modes);
template int ReadModesFromDisk<float>(char * filename, int * n, int * r, float ** frequencies, float ** modes);

template int WriteModesToDisk<double>(char * filename, int n, int r, double * frequencies, double * modes);
template int WriteModesToDisk<float>(char * filename, int n, int r, float * frequencies, float * modes);
...
template int ReadMatrixFromDiskListOfFiles<double>(char * fileList, int * m, int * n, double ** matrix);
template int ReadMatrixFromDiskListOfFiles<float>(char * fileList, int * m, int * n, float ** matrix);
...
template int ReadMatrixFromDiskTextFile<double>(char* filename, int * m, int * n, double ** matrix);
template int ReadMatrixFromDiskTextFile<float>(char* filename, int * m, int * n, float ** matrix);

template int WriteMatrixToDiskTextFile<double>(char* filename, int m, int n, double * matrix);
template int WriteMatrixToDiskTextFile<float>(char* filename, int m, int n, float * matrix);
